-- =====================================================
-- ULTIMATE FIX: Gereksiz trigger'ları temizle
-- Sadece update_conversation_on_message trigger'ını tut
-- =====================================================
...
-- 2. Eski fonksiyonları da kaldır
...
-- 3. Mevcut trigger fonksiyonunu yeniden oluştur (güvenli versiyon)
...
DECLARE
    ...
    v_conv_id UUID;
BEGIN
    -- conversation_id'nin UUID olduğundan emin ol
    v_conv_id := NEW.conversation_id::UUID;
...
-- 5. RPC fonksiyonunu da garantile
...
DO $$
BEGIN
    RAISE NOTICE '✅ ULTIMATE FIX tamamlandı - Triggerlar temizlendi!';
END $$;
