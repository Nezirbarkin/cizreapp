-- =====================================================
-- TAKİP İSTEĞİ ONAYLAMA SİSTEMİ - TAM KONTROL
-- =====================================================
...
-- 5. follows tablosu trigger'ları
SELECT 
    trigger_name,
    event_manipulation,
    action_statement
...
-- 6. notification_types enum'de 'follow_request_accepted' var mı?
SELECT 
    enumlabel
FROM pg_enum
