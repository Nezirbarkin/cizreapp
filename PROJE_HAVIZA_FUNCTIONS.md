...
- `mark_messages_as_read(p_conversation_id)` — CHAT: SADECE karşı tarafın (sender_id=partner) mesajlarını okundu yapar, her iki conversation kopyasında. Kendi mesajını okundu YAPMAZ. Okundu bilgisi yalnızca ALICI tarafından işaretlenir. (20260702_CHAT_READ_RECEIPT_FIX.sql)
...
- SONUÇLARI (client'ta MUTLAKA uyulmalı):
  ...
  3. Okundu işaretleme yalnızca ALICI tarafından: `mark_messages_as_read` (sender_id=partner satırlarını her iki conv'da true yapar).
