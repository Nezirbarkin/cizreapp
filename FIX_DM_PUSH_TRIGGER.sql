-- ============================================================================
-- 1:1 SOHBET PUSH BİLDİRİM TRİGGER - DÜZELTME
-- ============================================================================
-- conversations tablosu çift yönlüdür (2 satır her konuşma için)
-- user_id != sender_id olan satırdan user_id al = alıcı
-- ============================================================================
...
DECLARE
  ...
  request_id BIGINT;
BEGIN
  -- conversations tablosundan ALICIYI bul
  -- Her konuşma 2 satır: (user_id=A, other_user_id=B) ve (user_id=B, other_user_id=A)
  -- sender_id olmayan user_id = alıcı
...
-- Kontrol
SELECT '✅ 1:1 sohbet push trigger oluşturuldu!' AS durum;
