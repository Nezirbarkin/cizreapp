-- =====================================================
-- RPC Function: send_message_direct - ULTIMATE FIX
-- String parametreyi UUID'ye explicit cast et
-- =====================================================
...
CREATE OR REPLACE FUNCTION public.send_message_direct(
    p_conversation_id TEXT,  -- STRING olarak gönderiliyor
    p_content TEXT
)
RETURNS JSON
LANGUAGE plpgsql
...
DO $$
BEGIN
    RAISE NOTICE '✅ send_message_direct with STRING to UUID cast!';
END $$;
