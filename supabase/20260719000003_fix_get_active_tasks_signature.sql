-- =============================================================================
-- 20260719000003_fix_get_active_tasks_signature.sql
-- Önceki migration'da RETURN TABLE'a created_at eklenmediği için runtime'da
-- 'structure of query does not match function result type' hatası oluşuyor.
-- DROP + CREATE ile yeniden tanımlıyoruz.
--
-- Ayrıca s2/s3 subquery'lerinde id/status unqualified kalmıştı → 42702
-- column reference "id" is ambiguous hatası veriyordu. Qualifier eklendi.
-- =============================================================================
...
DO $$ BEGIN
  RAISE NOTICE '✅ 20260719000003_fix_get_active_tasks_signature.sql — task_id + created_at + qualified subqueries';
END $$;